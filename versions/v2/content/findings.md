...
| `labels_contains_all[]` | N/A     | If specified, returns findings that contain all of the specified labels. This query param can be specified multiple times. Returns an empty list of no matches are found. Example: `https://api.cobalt.io/findings?labels_contains_all[]=Awaiting Feedback&labels_contains_all[]=Retest Blocked`                                             |
