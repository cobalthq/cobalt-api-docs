...
| `limit`   | `10`    | If specified, returns only a specified amount of findings, for example `https://api.cobalt.io/findings?limit=5`                          |
| `pentest` | N/A     | If specified, returns findings scoped to this pentest id, for example `https://api.cobalt.io/findings?pentest=pt_PEtv4dqnwGV2efZhLw3BM5` |
| `asset`   | N/A     | If specified, returns findings scoped to this asset id, for example `https://api.cobalt.io/findings?asset=as_HcChCMueiPQQgvckmZtRSd`     |
