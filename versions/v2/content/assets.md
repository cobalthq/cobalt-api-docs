...
| `asset_type` | N/A     | If specified, returns assets that match `asset_type` exactly. See Response Fields below for example `asset_type` values. Example: `https://api.cobalt.io/assets?asset_type=web` |
